...
const SingleTestimonial = () => {
	return (
		<div>
			<div className="group w-full bg-white dark:bg-gray-600 relative flex flex-col items-center hover:dark:bg-indigo-700 hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
				<div className="text-gray-600 dark:text-gray-100  group-hover:text-white flex flex-col items-center">
					<svg
						width={26}
						height={27}
						viewBox="0 0 26 27"
			...
			<div className="flex flex-col items-center justify-center mt-10">
				<img
					...
					className="w-12 h-12"
				/>
				<p className="text-base font-semibold leading-4 my-2 text-gray-800 dark:text-white">
					Tom Koch
				</p>
				<p className="text-base leading-4 text-center text-gray-600 dark:text-gray-400">
					Developer
				</p>
			</div>
		</div>
